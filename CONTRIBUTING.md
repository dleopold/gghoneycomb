...
This outlines how to propose a change to gghoneycomb. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("dleopold/gghoneycomb", fork = TRUE)`.
...
Please note that the gghoneycomb project is released with a [Contributor
Code of
Conduct](https://dleopold.github.io/gghoneycomb/CODE_OF_CONDUCT.md). By
